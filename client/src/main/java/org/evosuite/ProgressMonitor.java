...
public class ProgressMonitor implements SearchListener, Serializable {
	...
	public void iteration(GeneticAlgorithm<?> algorithm) {
		...
		//currentCoverage = (int) Math.floor(((TestSuiteChromosome) algorithm.getBestIndividualNovelty()).getCoverageNovelty() * 100);
	...
	public void fitnessEvaluation(Chromosome individual) {
		...
		if(individual.getFitnessValues().isEmpty())
		{
			currentCoverage = (int) Math.floor(((TestSuiteChromosome) individual).getCoverageNovelty() * 100);
		}
		else
		{
