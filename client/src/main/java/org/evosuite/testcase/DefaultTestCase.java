...
public class DefaultTestCase implements TestCase, Serializable {
	...
	private transient Set<TestNoveltyFunction> coveredGoalsNovelty = new LinkedHashSet<TestNoveltyFunction>();
	...
	@Override
	public void addCoveredGoal(TestNoveltyFunction goal){
		coveredGoalsNovelty.add(goal);
	}
	...
	@Override
	public boolean isGoalCovered(TestNoveltyFunction goal){
		return coveredGoalsNovelty.contains(goal);
	}
	...
	public DefaultTestCase clone() {
		...
		*/
		...
		t.coveredGoalsNovelty.addAll(coveredGoalsNovelty);
	...
	@Override
	public Set<TestNoveltyFunction> getCoveredGoalsNovelty() {
		return coveredGoalsNovelty;
	}
	...
	private void readObject(ObjectInputStream ois) throws ClassNotFoundException,
		...
		coveredGoalsNovelty = new LinkedHashSet<TestNoveltyFunction>();
