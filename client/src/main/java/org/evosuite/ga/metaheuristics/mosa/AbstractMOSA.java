...
public abstract class AbstractMOSA<T extends Chromosome> extends GeneticAlgorithm<T> {
	...
	protected List<TestSuiteNoveltyFunction> suiteNovelties;
	...
	public AbstractMOSA(ChromosomeFactory<T> factory) {
		...
		for (Properties.Criterion criterion : Properties.CRITERION){
			...
			TestSuiteNoveltyFunction novel = NoveltyFunctions.getNoveltyFunction(criterion);
			suiteFitnesses.add(fit);
			suiteNovelties.add(novel);
		}
